<script id="doctorSessionTemplate" type="text/x-jsrender">
    ...
    <a href="#" data-id={{:id}}" class="doctor-session-delete-btn btn btn-icon btn-bg-light text-hover-primary btn-sm" data-bs-toggle="tooltip" title="Delete">
                        <span class="svg-icon svg-icon-3">
