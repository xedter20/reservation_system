<div class="dropdown d-flex align-items-center me-4 me-md-2" wire:ignore>
    ...
    <div class="dropdown-menu py-0" aria-labelledby="doctorHolidayFilterBtn">
        ...
        <div class="p-5">
            <div class="mb-5">
                ...
                <input type="text" class="form-control form-control-solid flatpickr-input" placeholder="Pick date range"
                       id="doctorHolidayDateFilter"/>
            </div>
            <div class="d-flex justify-content-end">
                <button type="reset" class="btn btn-secondary" id="doctorHolidayResetFilter">{{__('messages.common.reset')}}</button>
            </div>
        </div>
    </div>
</div>
