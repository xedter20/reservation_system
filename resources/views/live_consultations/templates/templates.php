    ...
    {{/if}}
     ...
     {{if isDoctor || isAdmin}}
        {{if !isMeetingFinished}}
            <a href="javascript:void(0)" title="<?php echo __('messages.common.edit') ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 live-consultation-edit-btn" data-id="{{:id}}">
        ...
        {{/if}}
            <a href="#" title="<?php echo __('messages.common.delete') ?>" data-id={{:id}}" class="live-consultation-delete-btn btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
                <span class="svg-icon svg-icon-3">
