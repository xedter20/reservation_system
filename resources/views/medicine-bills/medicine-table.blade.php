                ...
                <table class="table table-striped" id="prescriptionMedicalTbl">
                    ...
                    <tbody class="medicine-bill-container">
                        ...
                        @else
                            <tr>
                                <td>
                                    {{ Form::select('category_id[]', $medicineCategories, null, ['class' => 'form-select medicineBillCategoriesId select2Selector','required','placeholder'=>'Select Category', 'data-id' => 1,'data-control'=>'select2']) }}
                                </td>
                                <td>
            ...
            <div class="row mt-5 justify-content-between">
                ...
                <div class="col-xl-4 col-md-5">
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <label class="fw-bold text-muted py-3 required">{{ __('messages.purchase_medicine.total') }}</label>
                        </div>
                        <div>
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <label class="fw-bold text-muted required py-3">{{ __('messages.purchase_medicine.discount') }}</label>
                        </div>
                        <div>
