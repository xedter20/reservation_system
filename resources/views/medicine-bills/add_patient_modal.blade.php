    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('password', __('auth.password').':', ['class' => 'form-label']) }}<span class="required"></span>
                        {{ Form::password('password', ['class' => 'form-control','required','min' => '6','max' => '10', 'tabindex' => '10']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('password_confirmation', __('auth.confirm_password').':', ['class' => 'form-label']) }}
                        <span class="required"></span>
