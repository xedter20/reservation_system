<div class="row mb-5">
    ...
    <div class="form-group col-md-3 mb-5">
        ...
        {{ Form::select('patient_id',$patients, null, ['class' => 'form-select','required','id' => 'editPrescriptionPatientId','placeholder'=> __('messages.medicine_bills.select_patient')]) }}
    </div>
    ...
    @else
        <div class="form-group col-md-3 mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('doctor_id',$doctors, null, ['class' => 'form-select','required','id' => 'editPrescriptionDoctorId','placeholder'=> __('messages.common.select_doctor')]) }}
        </div>
    @endif
    <div class="col-md-3">
